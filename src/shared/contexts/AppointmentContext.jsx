...
export const AppointmentProvider = ({ children }) => {
  ...
  const addAppointment = (newAppointment) => {
    const appointmentWithId = {
      ...
      estado: newAppointment.estado || 'solicitada', // Estado por defecto a 'solicitada'
      historial: [] // Agregar array para historial de cambios
    };
  ...
  const updateAppointmentStatus = (id, newStatus, motivo = '') => {
    setAppointments(prev => {
      const newAppointments = prev.map(appointment => {
        if (appointment.id === id) {
          ...
          return {
            ...appointment,
            estado: newStatus,
            historial: [...(appointment.historial || []), historialEntry]
          };
        }
        return appointment;
      });
