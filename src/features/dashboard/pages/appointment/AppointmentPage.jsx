...
const CitasPage = () => {
  ...
  const stats = {
    ...
    're agendada': appointments.filter(c => c.estado === 're agendada').length,
    solicitada: appointments.filter(c => c.estado === 'solicitada').length
  };
  ...
  const oldPendingAppointments = appointments.filter(cita => {
  ...
  const handleAcceptAppointment = () => {
    if (selectedCita) {
      ...
      toast({
        ...
        description: `La cita con ${selectedCita.cliente} ha sido confirmada.`,
        variant: "default"
      });
    }
  };
  ...
  const handleRejectAppointment = () => {
    if (selectedCita) {
      ...
      toast({
        ...
        description: `La cita con ${selectedCita.cliente} ha sido cancelada.`,
        variant: "default"
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
        ...
        <ConfirmationDialog
          ...
          message={`¿Estás seguro de que deseas aceptar la cita solicitada con ${selectedCita?.cliente}? La cita pasará al estado "Confirmada".`}
        ...
        <ConfirmationDialog
          ...
          message={`¿Estás seguro de que deseas rechazar la cita solicitada con ${selectedCita?.cliente}? La cita pasará al estado "Cancelada".`}
